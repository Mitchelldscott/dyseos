 ...
 *
 ********************************************************************************/
//! # DyseOS Aarch64 Boot routines
//!
//! Author: Mitchell Scott <scott.mitchell913@gmail.com>
//!
//! Copied from Andre Richter's Rust RaspberryPi tutorials
//!
...
/// Park the core
///
/// loops and waits for an event. Requires that the linker poses a .text section
///
/// ### Disassembly
/// ```
///
